// File: lib/screens/auth/athlete_signup_page.dart
...
class AthleteSignupPage extends StatefulWidget {
  ...
  const AthleteSignupPage({Key? key, required this.userRole}) : super(key: key);

  @override
  State<AthleteSignupPage> createState() => _AthleteSignupPageState();
}
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => SportsLoginPage(userRole: widget.userRole),
                            ),
                          );
                        },
                        child: const Text(
